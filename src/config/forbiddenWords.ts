...
export const forbiddenWords = {
  ...
  pornWords: [
    ...
    '性功能障碍', '性冷淡',
    // 新增性器官相关词汇（中文）
    '阴茎', '阴道', '生殖器', '乳房', '胸部', '私处', '下体',
    // 新增性器官相关词汇（英文）
    'penis', 'vagina', 'genitals', 'breast', 'boobs', 'dick', 'pussy',
    // 新增性器官相关词汇（拼音）
    'yinjing', 'yindao', 'shengzhiqi', 'rufang', 'xiongbu', 'sichu', 'xiati',
    // 新增口语化性器官词汇（中文）
    '鸡鸡', '鸡巴', '逼','吊', '屌','肛', '小弟弟', '小妹妹', '小鸡鸡', '小鸟', '命根子', '那话儿', '蛋蛋',
    '咪咪', '奶子', '波波', '胸脯', '大胸', '凶', '凶器',
    // 新增口语化性器官词汇（拼音）
    'didi', 'jiji', 'nainai', 'xiong', 'dandan', 'mimi', 'bobo'
  ],
